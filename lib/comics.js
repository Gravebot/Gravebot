...
const help_text = `Comics commands
Get random web comic strips
...
**\`!comic css\`** or **\`!comic chainsawsuit\`**
    Returns a random chainsawsuit comic
**\`!comic dhd\`** or **\`!comic dog house diaries\`**
    Returns a random Dog House Diaries comic
...
**\`!comic to\`** or **\`!comic the oatmeal\`**
    Return a random The Oatmeal comic
**\`!comic xkcd\`**
